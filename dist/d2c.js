(function(exports, global) {
    ...
    var bar = function(selection, data) {
        ...
        var bars = chart.renderArea.selectAll(".bar").data(data).enter().append("rect").attr("class", "bar").attr("x", 0).attr("y", function(d) {
        ...
        var tooltip = d3.select("body").append("div").attr("class", "eeh-chart-tooltip").style("opacity", 1);
    ...
    var ChartBase = function(selection, chartClass) {
        ...
        this.svg = this.selection.append("svg").attr("class", "eeh-chart eeh-chart-" + chartClass).attr("width", config.width).attr("height", config.height);
    ...
    var line = function(selection, data) {
        ...
        var tooltip = d3.select("body").append("div").attr("class", "eeh-chart-tooltip eeh-chart-tooltip-content").style("opacity", 0);
        ...
        function renderTooltip(data) {
            ...
            tooltipRectangleGroup.selectAll(".tooltip-rect").data(data[0].data).enter().append("rect").attr("height", config.paddedHeight()).attr("width", tooltipRectangleWidth).attr("opacity", 0).classed("tooltip-rect", true).attr("x", function(d) {
